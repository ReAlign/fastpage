...
let main = (obj) => {
    ...
    mo.readMcssList = [`${mo.baseTplPath}main.mcss`];
    ...
    let replaceAll = (key, info) => {
        for (let layer of mo[key]) {
            ...
            text = text.replace(/~date~/g, moment().format('YYYY-MM-DD'))
                ...
                .replace(/~newTopPath~/g, mo.topPath)
